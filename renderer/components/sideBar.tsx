...
export const SideBar: React.FC<NavigationBarProps> = ({ handleOpenSettings }) => {
  return (
    <div className="fixed w-[60px] h-[690px] bottom-0 left-0 bg-white rounded-[40px] shadow-[0px_4px_4px_#00000040]">
